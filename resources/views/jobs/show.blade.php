            ...
            <div class="alert alert-danger border-0 shadow-sm rounded-4 mb-4 d-flex align-items-center gap-3">
                ...
                <div>
                    <h6 class="fw-bold mb-0 text-danger">
                        {{ app()->getLocale() === 'ar' ? 'تم شغل هذه الوظيفة ولم تعد متاحة للتقديم.' : 'This job has been filled and is no longer available for application.' }}
                    </h6>
                </div>
            </div>
        @endif
            ...
            <div class="card-body p-4">
                ...
                @if($job->is_filled)
                    <div class="text-center py-3">
                        ...
                        <p class="text-muted fw-bold">{{ app()->getLocale() === 'ar' ? 'تم شغل هذه الوظيفة' : 'This job is filled' }}</p>
                        <button type="button" class="btn btn-secondary w-100 rounded-pill py-2 fw-bold btn-apply-disabled" disabled>
