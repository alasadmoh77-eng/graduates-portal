            ...
            <form action="{{ route('admin.requests.index') }}" method="GET" class="row g-3">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6">
                    ...
                    <select name="status" class="form-select custom-input">
                        ...
                        @foreach(['SUBMITTED', 'UNDER_REVIEW', 'APPROVED', 'REJECTED', 'READY', 'ISSUED'] as $status)
                ...
                <div class="col-xl-2 col-lg-4 col-md-6">
                    ...
                    <input type="date" name="date_from" class="form-control custom-input" value="{{ request('date_from') }}">
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6">
                    <label class="form-label small fw-bold text-muted">إلى تاريخ</label>
                    <div class="d-flex gap-2">
                        <input type="date" name="date_to" class="form-control custom-input" value="{{ request('date_to') }}">
