                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr class="text-center">
                            ...
                            <th>سنة التخرج</th>
                            <th>تاريخ التسجيل</th>
                            <th class="py-3">السجل الأكاديمي</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse($graduates as $grad)
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{ route('admin.graduates.academic-record.edit', $grad) }}" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                                        <i class="fas fa-graduation-cap me-1"></i> إدخال / تعديل
                                    </a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="6" class="p-5 text-center text-muted italic">لا يوجد خريجين يطابقون معايير البحث.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
