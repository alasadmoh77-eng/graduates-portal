...
@section('styles')
    ...
    <style>
        ...
        .academic-page-content input:focus {
            background-color: #fbf8fcff !important;
            box-shadow: 0 0 0 1px #d8cbe1ff !important;
        ...
        .ar-page-header .breadcrumb a:hover {
            color: #b89047;
        }
...
@section('content')
    ...
    <div class="academic-toolbar-page">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('app.dashboard') }}</a>
                        </li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.reports.graduates') }}">{{ __('app.manage_graduates') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('app.academic_record_entry_title') }}
                        </li>
                    </ol>
                </nav>
        ...
        <div class="academic-layout-root"
            x-data="documentState({{ \Illuminate\Support\Js::from($initial) }}, {{ \Illuminate\Support\Js::from($saveEndpoint) }}, {{ \Illuminate\Support\Js::from($catalog) }})">
                        ...
                        <table class="header-table">
                            <tr>
                                ...
                                <td class="header-center">
                                    ...
                                    <div class="header-doc-title">سجل الطالب الأكاديمي</div>
                                </td>
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <div class="student-field-line">
                                        ...
                                        <input type="text" class="important-value" x-model="student.enrollmentYear"
                                            inputmode="numeric"
                            ...
                            <tr>
                                <td>
                                    <div class="student-field-line">
                                        ...
                                        <input type="text" class="important-value" x-model="student.gradYear"
                                            inputmode="numeric"
                                ...
                                <td>
                                    <div class="student-field-line">
                                        ...
                                        <input type="text" class="important-value" x-model="student.id"
                                ...
                                <table class="level-header-bar">
                                    <tr>
                                        <td style="width: 20%; text-align: right;">
                                            ...
                                            <input type="text" class="level-result-input field-readonly" readonly
                                                tabindex="-1" x-model="level.result"
                                                style="width: 50px; border: none; font-weight: bold; background: transparent; text-align: right;">
                                        </td>
                                        <td style="width: 20%; text-align: right;">
                                        ...
                                        <td style="width: 25%; text-align: right;">
                                            ...
                                            <input type="text" x-model="level.year"
                                                style="width: 80px; display: inline-block; text-align: center; border: 1px solid #ccc; font-size: 7.5px; padding: 1px;">
                                        </td>
                                        <td
                                            style="width: 15%; text-align: center; background-color: #f1f5f9; font-weight: bold;">
                                    ...
                                    <tr>
                                        <template x-for="(sem, sIdx) in level.semesters" :key="sIdx">
                                            <td :class="sIdx == 0 ? 'first-sem' : 'second-sem'">
                                                <div class="sem-title"
                                                    x-text="sIdx == 0 ? 'الفصل الدراسي الأول' : 'الفصل الدراسي الثاني'">
                                                </div>
                                                <table class="subjects-table">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" x-model="sub.hours"
                                                                        :readonly="!!sub.catalog_key"
                                                                        :class="sub.catalog_key ? 'field-readonly' : ''"
                                                                        :tabindex="sub.catalog_key ? -1 : 0"
                                                                        inputmode="decimal"
                                                                        @input="sub.hours = $event.target.value.replace(/[^0-9.]/g,''); recalculateAll();">
                                                                </td>
                                                                <td class="subj-name">
                                                                ...
                                                                <td class="d-print-none" style="background-color: #fff5f5;">
                                                                    <button type="button"
                                                                        @click="removeSub(lIdx, sIdx, subIdx)"
                                                                        class="btn-del-row"
                                                                        title="حذف مادة">&times;</button>
                                                                </td>
                                                            </tr>
                                                        </template>
                                                        <template x-if="sem.subjects.length === 0">
                                                            <tr>
                                                                <td colspan="6"
                                                                    style="text-align: center; color: #999; font-style: italic; font-size: 6.5px; padding: 4px; background: #fafafa;">
                                                                    لا توجد مقررات في هذا الفصل — استخدم «إضافة مادة»</td>
                                                            </tr>
                                                        </template>
                                                        <tr class="add-btn-row d-print-none">
                                                            <td colspan="6" style="padding: 2px;">
                                                                <button type="button" @click="addSub(lIdx, sIdx)"
                                                                    class="btn-add-sub">+ إضافة مادة</button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                    ...
                    <div class="admin-document-signatures-section">
                        <table class="sig-table" style="width: 100%; border-collapse: collapse; border: none; direction: ltr;">
                            <tr>
                                ...
                                <td class="signature-cell" style="width: 25%;">
                                    <div class="sig-title">مدير إدارة شؤون الخريجين</div>
                                    <div class="sig-line"></div>
                                </td>
                                <td class="signature-cell" style="width: 25%;">
                                    <div class="sig-title">المختص الأكاديمي</div>
                                    <div class="sig-line"></div>
                                </td>
                            </tr>
                        </table>
            ...
            <div class="admin-toolbar d-print-none">
                <button type="button" @click.prevent="resetData()" class="btn-admin btn-reset" data-tooltip="إعادة تعيين"
                    title="إعادة تعيين"><i data-lucide="rotate-ccw"></i></button>
                <button type="button" @click.prevent="window.print()" class="btn-admin btn-print" data-tooltip="طباعة"
                    title="طباعة"><i data-lucide="printer"></i></button>
                @isset($graduate)
                    <a href="{{ route('admin.graduates.academic-record.download', $graduate) }}" class="btn-admin btn-download"
                        style="background: #2563eb; color: white; display: flex; align-items: center; justify-content: center; text-decoration: none;"
                        data-tooltip="تحميل PDF" title="تحميل PDF"><i data-lucide="download"></i></a>
                @endisset
                <button type="button" @click.prevent="saveData()" class="btn-admin btn-save" :disabled="saving"
                    data-tooltip="حفظ" title="حفظ في النظام"><i data-lucide="save"></i></button>
            </div>
        </div>
    </div>
@endsection
