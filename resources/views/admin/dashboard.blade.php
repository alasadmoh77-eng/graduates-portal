    ...
    <div class="col-sm-6 col-lg-4 col-xl-2">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);">
            <div class="card-body p-4">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['total_approved_graduates']) }}</h2>
                <p class="mb-0 text-secondary small fw-bold">{{ __('app.total_approved_graduates') }}</p>
    ...
    <div class="col-sm-6 col-lg-4 col-xl-2">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); animation-delay: 0.1s;">
            <div class="card-body p-4">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['total_employers']) }}</h2>
                <p class="mb-0 text-secondary small fw-bold">{{ __('app.total_employers') }}</p>
                <div class="position-absolute bottom-0 end-0" style="opacity: 0.04; pointer-events: none; margin-right:-20px; margin-bottom:-25px;">
    ...
    <div class="col-sm-6 col-lg-4 col-xl-2">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); animation-delay: 0.2s;">
            <div class="card-body p-4">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['total_issued_documents']) }}</h2>
...
<div class="row g-4 mb-5">
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <a href="{{ route('admin.faculties.index') }}" class="text-decoration-none h-100 d-block">
        @endif
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['total_faculties']) }}</h2>
                <p class="mb-0 text-secondary small fw-bold">{{ __('app.total_faculties') }}</p>
                <div class="position-absolute bottom-0 end-0" style="opacity: 0.04; pointer-events: none; margin-right:-20px; margin-bottom:-25px;">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); animation-delay: 0.1s;">
            <div class="card-body p-4">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['total_majors']) }}</h2>
                <p class="mb-0 text-secondary small fw-bold">{{ __('app.total_majors') }}</p>
                <div class="position-absolute bottom-0 end-0" style="opacity: 0.04; pointer-events: none; margin-right:-20px; margin-bottom:-25px;">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); animation-delay: 0.2s;">
            <div class="card-body p-4">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['total_document_requests']) }}</h2>
                <p class="mb-0 text-secondary small fw-bold">{{ __('app.total_document_requests') }}</p>
                <div class="position-absolute bottom-0 end-0" style="opacity: 0.04; pointer-events: none; margin-right:-20px; margin-bottom:-25px;">
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); animation-delay: 0.3s;">
            <div class="card-body p-4">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['total_active_jobs']) }}</h2>
                <p class="mb-0 text-secondary small fw-bold">{{ __('app.total_active_jobs') }}</p>
                <div class="position-absolute bottom-0 end-0" style="opacity: 0.04; pointer-events: none; margin-right:-20px; margin-bottom:-25px;">
    ...
    <div class="col-sm-6 col-lg-3">
        <a href="{{ route('admin.pending-signatures') }}" class="text-decoration-none h-100 d-block">
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    @if($stats['pending_signatures'] > 0)
                        <span class="badge bg-danger rounded-pill px-2">{{ $stats['pending_signatures'] }}</span>
                    @endif
                </div>
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['pending_signatures']) }}</h2>
    ...
    <div class="col-sm-6 col-lg-3">
        <a href="{{ route('admin.ready-signatures') }}" class="text-decoration-none h-100 d-block">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative animate__animated animate__fadeInUp" style="transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); animation-delay: 0.4s;">
            <div class="card-body p-4">
                ...
                <h2 class="fw-extrabold mb-1 font-monospace text-dark" style="font-size: 2.2rem;">{{ number_format($stats['completed_signatures']) }}</h2>
