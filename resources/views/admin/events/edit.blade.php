                ...
                <form action="{{ route('admin.events.update', $event) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="datetime-local" name="start_at" class="form-control date-input @error('start_at') is-invalid @enderror"
                                   value="{{ $startValue }}" required dir="ltr" lang="en">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="seats" class="form-control @error('seats') is-invalid @enderror"
                                   value="{{ old('seats', $event->seats) }}" min="1" placeholder="—" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
