                ...
                <div class="col-md-8">
                    ...
                    >
                        <dl class="row mb-0 small">
                             ...
                             <dt class="col-sm-4 text-muted mt-2">{{ __('app.faculty') }}</dt>
                             <dd class="col-sm-8 fw-bold mt-2">{{ $g->major && $g->major->faculty ? (app()->getLocale() === 'ar' ? $g->major->faculty->name_ar : $g->major->faculty->name_en) : '—' }}</dd>
                             ...
                             <dt class="col-sm-4 text-muted mt-2">{{ __('app.degree') }}</dt>
                             <dd class="col-sm-8 fw-bold mt-2">{{ $g->major ? (app()->getLocale() === 'ar' ? $g->major->degree_name_ar : $g->major->degree_name_en) : '—' }}</dd>
