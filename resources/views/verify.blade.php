...
<div class="row justify-content-center py-5">
    <div class="col-md-8">
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden" style="border-bottom: 4px solid #b89047;">
            <div class="card-header text-white p-4 text-center border-0" style="background: var(--primary-color); border-bottom: 3px solid #b89047;">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <form action="{{ route('verify.process') }}" method="POST" class="mb-5">
                    ...
                    <div class="input-group input-group-lg shadow-sm">
                        <input type="text" name="token" class="form-control border-primary" placeholder="أدخل الرقم التسلسلي، المرجعي، أو رمز التحقق للوثيقة..." value="{{ $token ?? '' }}" required>
                ...
                @if(isset($document) && $document->is_valid)
                    ...
                    <div class="alert alert-success border-0 shadow-sm p-4 rounded-4 mb-0 animate__animated animate__fadeIn">
                        ...
                        <div class="row g-4 text-start" dir="rtl">
                            ...
                            <div class="col-md-6">
                                <label class="small text-muted d-block">الكلية</label>
                                <span class="fw-bold fs-5 text-dark">{{ $document->documentRequest->user->graduate->major->faculty->name_ar ?? '---' }}</span>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label class="small text-muted d-block">الدرجة العلمية</label>
                                <span class="fw-bold fs-5 text-dark">{{ $document->documentRequest->user->graduate->major->degree_name_ar ?? '---' }}</span>
                            </div>
                            <div class="col-md-6">
                                <label class="small text-muted d-block">سنة التخرج</label>
                                <span class="fw-bold fs-5 text-dark">{{ $document->documentRequest->user->graduate->graduation_year ?? '---' }}</span>
                            </div>
                            <div class="col-md-6">
